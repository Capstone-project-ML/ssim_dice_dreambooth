...
def main():
    ...
    if checkpoint_dirs:
        ...
        if latest_checkpoint_dir:
            ...
            # Load optimizer/scaler/scheduler state if available
            ...
            if os.path.exists(state_path):
                ...
                global_step_resume = state["global_step"]
                print(f"Resumed optimizer, scaler, and scheduler from checkpoint epoch {state['epoch']}.")
