...
class DreamBoothDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        instance_mask = Image.open(instance_mask_path).convert("L") # Ensure mask is loaded as grayscale
    ...
    for epoch in range(args.num_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with torch.cuda.amp.autocast():
                ...
                # --- PREDICT ORIGINAL IMAGE FROM NOISE ---
                ...
                pred_images_norm = (pred_images + 1) / 2 # Renormalize from [-1, 1] to [0, 1]
                ...
                # --- COMBINED LOSS ---
                loss = dreambooth_loss + args.ssim_loss_weight * ssim_loss + args.dice_loss_weight * dice_loss
