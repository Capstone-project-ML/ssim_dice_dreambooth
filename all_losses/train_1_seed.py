...
def main():
    ...
    if args.seed is not None:
        ...
        # Force deterministic operations for reproducibility (can slightly impact performance)
    ...
    # If seed is set, explicitly use a generator for DataLoader shuffling
    ...
    for epoch in range(args.num_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with ctx:
                ...
                # If using a seed, optionally make the timestep sampling deterministic, 
                # but standard practice allows random timestep generation on the set seed.
        ...
        # --- CHECKPOINTING ---
        # Changed to save after every epoch instead of by step
