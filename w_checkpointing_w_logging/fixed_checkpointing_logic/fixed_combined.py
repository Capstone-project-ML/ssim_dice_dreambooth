# train_dreambooth_ssim_dice_with_logging.py
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(description="DreamBooth fine-tuning with a combined SSIM and Dice loss.")
...
def main():
    ...
    # --- 1. SETUP SEGMENTATION MODEL AND DICE LOSS ---
    print("Loading pre-trained segmentation model for Dice loss...")
    ...
    print("Loaded and froze segmentation model.")
    ...
    # --- [FIX] CHECK FOR CHECKPOINTS AND RESUME ---
    initial_epoch = 0
    ...
    if os.path.isdir(args.output_dir):
        ...
        if checkpoint_dirs:
            ...
            for d in checkpoint_dirs:
                try:
                    ...
                    if epoch_num > latest_epoch:
                        # [FIX] Check if the full training state file exists
            ...
            if latest_checkpoint_dir:
                ...
                # [FIX] Load the full training state
                try:
    ...
    for epoch in range(initial_epoch, args.num_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with torch.cuda.amp.autocast():
                ...
                total_loss = dreambooth_loss + args.ssim_loss_weight * ssim_loss + args.dice_loss_weight * dice_loss
        ...
        # --- [FIX] SAVE CHECKPOINT WITH FULL TRAINING STATE ---
        ...
        # [FIX] Save the complete training state
        training_state = {
            'epoch': epoch + 1,
